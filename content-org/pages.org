...
You read all the way to here? Clearly you are interested in how this all went for me. See my update to this post [[/posts/split-keyboard-v2/][here]].
...
** update 2025-08-11: now available online!

view and use this project [[https://lilypoint.mazzaella.com/][here]]
...
[[/lilypond/program_output6.1.2022.txt][outputted .txt file]]
...
- [[https://lilypoint.mazzaella.com/][lilypoint.mazzaella.com]] my lilypond counterpoint generator
- [[https://www.hacklily.org/][hacklily.org]] preview .ly files online (and listen to them, in the wrong key)
- [[http://lilypond.org/][lilypond.org]] main lilypond site
- [[https://www.mutopiaproject.org/][mutopiaproject.org]] free classical sheet music with .ly format available
...
* hours calculator                       :code:javascript:reference:tools:
:PROPERTIES:
...
* hammock suspension                         :reference:ideas:hammock:diy:knots:design:tools:
:PROPERTIES:
...
* on ai                         :code:ai:
:PROPERTIES:
:EXPORT_FILE_NAME: on-ai
:EXPORT_DATE: 2025-07-13
:EXPORT_TITLE: on ai
:EXPORT_HUGO_CATEGORIES: notes
:END:
...
I worked everything out on a whiteboard and in [[https://www.desmos.com/calculator][desmos]],
and then solved the equations using [[https://www.wolframalpha.com/input?i2d=true&i=Power%5B%5C%2840%29x-%5C%2840%29Divide%5Br%2Ctan%5C%2840%29Divide%5B%5C%2840%29180-a%5C%2841%29%2C2%5D*Divide%5Bpi%2C180%5D%5C%2841%29%5D%5C%2841%29%5C%2841%29%2C2%5D%2BPower%5B%5C%2840%29y%2Br%5C%2841%29%2C2%5D%3DPower%5Br%2C2%5D%5C%2844%29y%3Dx*tan%5C%2840%29a*Divide%5Bpi%2C180%5D%5C%2841%29][wolfram alpha]].
...
Here is an example so you can see how it works: [[https://view.mazzaella.com/how-this-link-works/#7jQLD4esBzsbsahk-6488QaCtu2OxgCb][how this link works]] (Note, this was built by Grok 4.6 if curious)
...
Now, clearly [[https://mazzaella.com/posts/on-ai/][how I use AI]] has changed since last year when I published my brief article about it. I will write an update and when I do link it here. Also as I was typing I kept wondering, hmm I haven’t written anything in a while, I wonder if I sound like an AI now. (The answer is [[https://www.pangram.com/history/d3d56397-792a-4bcb-a52a-b180ac998a9e?ucc=i7CfttfAUdj][no]]).

[[/images/pangram01.png]]
